...
void __attribute__((picinterrupt(("irq(default),base(1024)")))) Default_ISR()
{
...
# 109 "mcc_generated_files/system/src/interrupt.c"
void __attribute__((picinterrupt(("irq(INT0),base(1024)")))) INT0_ISR()
{
    (PIR1bits.INT0IF = 0);
...
# 143 "mcc_generated_files/system/src/interrupt.c"
void __attribute__((picinterrupt(("irq(INT1),base(1024)")))) INT1_ISR()
{
    (PIR6bits.INT1IF = 0);
...
# 177 "mcc_generated_files/system/src/interrupt.c"
void __attribute__((picinterrupt(("irq(INT2),base(1024),low_priority")))) INT2_ISR()
{
    (PIR10bits.INT2IF = 0);
