...
# 104 "mcc_generated_files/system/src/interrupt.c"
...
# 138 "mcc_generated_files/system/src/interrupt.c"
...
# 172 "mcc_generated_files/system/src/interrupt.c"
void __attribute__((picinterrupt(("irq(INT2),base(1024)")))) INT2_ISR()
{
    (PIR10bits.INT2IF = 0);
