...
# 98 "mcc_generated_files/timer/src/../../system/pins.h"
...
void __attribute__((picinterrupt(("irq(TMR0),base(1024)")))) Timer0_OverflowISR()
{
    static volatile uint16_t CountCallBack = 0;
    do { LATBbits.LATB4 = ~LATBbits.LATB4; } while(0);

    PIR3bits.TMR0IF = 0;
# 125 "mcc_generated_files/timer/src/tmr0.c"
}
