...
# 30 "./ILI9225.h"
    ...
    {0x00, 0x18, 0x3C, 0x7E, 0xFF, 0x00, 0x00, 0x18, 0x3C, 0x7E, 0xFF, 0x00, 0x00},
    {0x00, 0x18, 0x3C, 0x7E, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0x7E, 0x3C, 0x18, 0x00}};
# 229 "./ILI9225.h"
...
void lcd_write_register(unsigned int reg, unsigned int data) {
    ...
    lcd_write_command(reg >> 8);
    lcd_write_command(reg & 0xFF);
...
void lcd_init_command_list(void)
{
    ...
    lcd_write_register((0x10u), 0x0000);
    lcd_write_register((0x11u), 0x0000);
    lcd_write_register((0x12u), 0x0000);
    lcd_write_register((0x13u), 0x0000);
    lcd_write_register((0x14u), 0x0000);

    delay_ms(10);

    lcd_write_register((0x11u), 0x0018);
    lcd_write_register((0x12u), 0x6121);
    lcd_write_register((0x13u), 0x006F);
    lcd_write_register((0x14u), 0x495F);
    lcd_write_register((0x10u), 0x0800);

    delay_ms(10);


    lcd_write_register((0x11u), 0x103B);

    delay_ms(50);


    lcd_write_register((0x01u), 0x011C);
    lcd_write_register((0x02u), 0x0100);
    lcd_write_register((0x03u), 0x1030);
    lcd_write_register((0x07u), 0x0000);
    lcd_write_register((0x08u), 0x0808);
    lcd_write_register((0x0Bu), 0x1100);
    lcd_write_register((0x0Cu), 0x0000);
    lcd_write_register((0x0Fu), 0x0D01);
    lcd_write_register((0x15u), 0x0020);
    lcd_write_register((0x20u), 0x0000);
    lcd_write_register((0x21u), 0x0000);


    lcd_write_register((0x30u), 0x0000);
    lcd_write_register((0x31u), 0x00DB);
    lcd_write_register((0x32u), 0x0000);
    lcd_write_register((0x33u), 0x0000);
    lcd_write_register((0x34u), 0x00DB);
    lcd_write_register((0x35u), 0x0000);
    lcd_write_register((0x36u), 0x00AF);
    lcd_write_register((0x37u), 0x0000);
    lcd_write_register((0x38u), 0x00DB);
    lcd_write_register((0x39u), 0x0000);


    lcd_write_register((0x50u), 0x0000);
    lcd_write_register((0x51u), 0x0808);
    lcd_write_register((0x52u), 0x080A);
    lcd_write_register((0x53u), 0x000A);
    lcd_write_register((0x54u), 0x0A08);
    lcd_write_register((0x55u), 0x0808);
    lcd_write_register((0x56u), 0x0000);
    lcd_write_register((0x57u), 0x0A00);
    lcd_write_register((0x58u), 0x0710);
    lcd_write_register((0x59u), 0x0710);

    lcd_write_register((0x07u), 0x0012);

    delay_ms(50);

    lcd_write_register((0x07u), 0x1017);
...
void set_draw_window(char x1, char y1, char x2, char y2) {
    ...
    lcd_write_register((0x36u),x2);
    lcd_write_register((0x37u),x1);

    lcd_write_register((0x38u),y2);
    lcd_write_register((0x39u),y1);

    lcd_write_register((0x20u),x1);
    lcd_write_register((0x21u),y1);
