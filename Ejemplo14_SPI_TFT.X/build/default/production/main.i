...
# 67 "main.c"
    ...
    fill_rectangle(0, 0, 220, 176, 0x0000);
    ...
    while(1) {
        fill_rectangle(0, 0, 220, 176, 0xAEDC);
        draw_string(64, 64, 0x0000, 1, "Hello World\0");
        delay_ms(1000);
        fill_rectangle(0, 0, 220, 176, 0xF800);
        draw_string(64, 64, 0x0000, 2, "Hello World\0");
        delay_ms(1000);
        fill_rectangle(0, 0, 220, 176, 0x07E0);
        draw_string(64, 64, 0x0000, 3, "Hello World\0");
        delay_ms(1000);
    }
}
